...
export class ListApiEvents extends Resource {
  ...
  constructor(
    ...
    this.snsTopic = new sns.SnsTopic(this, 'list-event-topic', {
  ...
  private createPolicyForEventBridgeToSns() {
    ...
    return new sns.SnsTopicPolicy(this, 'list-events-sns-topic-policy', {
      arn: this.snsTopic.arn,
