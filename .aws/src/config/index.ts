const name = 'PocketEventBridge'; //todo: change the service name, match shared infrastructure name
...
export const config = {
  ...
  codePipeline: {
    githubConnectionArn,
    repository: 'pocket/pocket_event_bridge', //TODO: Change to your github repository before first deployment
    branch,
  },
  graphqlVariant,
  cacheNodes,
